...
public interface ICommentService
{
    ...
    Task<PagedResponse<IReadOnlyList<CommentResponse>>> GetRepliesByParentIdAsync(Guid parentId, int pageNumber, int pageSize, CancellationToken cancellationToken);
