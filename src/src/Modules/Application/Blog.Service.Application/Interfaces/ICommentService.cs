...
public interface ICommentService
{
    ...
    Task<PagedResponse<IReadOnlyList<CommentResponse>>> GetAllCommentsAsync(int pageNumber, int pageSize, string searchName, CancellationToken cancellationToken);
